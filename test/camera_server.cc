...
public:
    EchoServer(const std::string& ptcp_dir, const std::string& name)
        ...
        image_buf = new char[image_width * image_height];
        count = 0;
    }
...
private:
    ...
    static const int image_height = 70; //480;
    char*   image_buf;
